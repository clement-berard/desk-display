<template>
  ...
  >
    <div class="relative h-full w-full rounded-lg overflow-hidden text-center bg-gray-800/50">
      <Skeleton v-if="pageItem?.backgroundImage" class="absolute inset-0 w-full h-full rounded-lg" />
